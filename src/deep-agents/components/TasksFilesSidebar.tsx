...
import type { TodoItem, FileItem } from "@/deep-agents/types";
import { useChatContext } from "@/deep-agents/providers/ChatProvider";
import { cn } from "@/lib/utils";
import { FileViewDialog } from "@/deep-agents/components/FileViewDialog";
        ...
        <div className="grid grid-cols-[repeat(auto-fill,minmax(256px,1fr))] gap-2">
          {Object.keys(files).map((file) => {
            ...
            if (
              ...
              rawContent !== null &&
              "content" in (rawContent as Record<string, unknown>)
            ) {
