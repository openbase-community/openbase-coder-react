    ...
    return (
      <DashboardLayout>
        <div className="ob-dashboard space-y-6">
          ...
          <header className="flex items-end justify-between gap-6 px-1 pb-1 pt-2">
          ...
          <div className="grid items-start gap-6 xl:grid-cols-[minmax(0,1.7fr)_minmax(280px,.8fr)]">
            <section className="overflow-hidden rounded-[20px] border border-primary/[0.09] bg-white/80 shadow-[0_18px_55px_-42px_rgba(24,73,139,.55)]">
            ...
            <div className="space-y-6">
              <section className="rounded-[20px] border border-primary/[0.09] bg-white/80 p-5 shadow-[0_18px_55px_-42px_rgba(24,73,139,.55)]">
